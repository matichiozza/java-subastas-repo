...
public class Publicacion {
    ...
    public Publicacion(String titulo, String descripcion, String categoria, String estado, Date fechaInicio, Date fechaFin, String condicion, float precioInicial, float incrementoMinimo, Usuario usuario) {
        this.titulo = titulo;
